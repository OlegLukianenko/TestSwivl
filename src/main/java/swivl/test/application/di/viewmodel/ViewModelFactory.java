...
public class ViewModelFactory implements ViewModelProvider.Factory {
    ...
    public ViewModelFactory(ViewModelComponent component) {
        ...
        creators.put(UserListFragmentViewModel.class, component::userFragmentViewModel);
        creators.put(ProfileFragmentViewModel.class, component::profileFragmentViewModel);
    }
